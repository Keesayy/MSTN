...
if __name__ == "__main__":
    ...
    pos_h, mst_h, cost, original_cost, iters, label = Heuristic_MSTN_alternating(G, strategy = "multistart", n_random = 0)
    fig2, ax2 = Draw_solution_centered(G, pos_h, mst_h, original_cost)
    fig2.savefig("2.png")

    Heuristic_Grid(G, max_iter=6, strategy='multistart', multistart_start=0, save_path="./3.png")

    print(cost, original_cost, iters)
